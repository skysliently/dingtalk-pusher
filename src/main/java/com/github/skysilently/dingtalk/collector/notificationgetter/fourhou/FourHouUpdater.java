...
@Data
@Component
public class FourHouUpdater extends NotificationUpdater {

    private String source = "https://www.4hou.com/feed";
    ...
    public ArrayList<NotificationModel> getNotificationsFromJsoup() {
        ...
        for (Element element:elements) {
            ...
            notificationModel.setInfoTitle("[嘶吼]" + element.select("title").text());

package com.github.skysilently.dingtalk.collector.notificationgetter.freebuf;
...
@Data
@Component
public class FreeBufUpdater extends NotificationUpdater {

    private String source = "https://www.freebuf.com/feed";
    ...
    public ArrayList<NotificationModel> getNotificationsFromJsoup() {
        ...
        for (Element element:elements) {
            ...
            notificationModel.setInfoTitle("[FreeBuf]" + element.select("title").text());
